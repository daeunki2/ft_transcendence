    ...
    <button
      ...
      style={{
        ...
        border: `${theme.borderWidth.thin} solid ${
          isRetro ? theme.colors.primary : theme.colors.border
        }`,
        borderRadius: '999px',
        background: isOn ? theme.colors.primary : theme.colors.surface,
        position: 'relative',
        cursor: 'pointer',
    ...
    >
      <span
        style={{
          ...
          height: '22px',
          borderRadius: '50%',
          background: isRetro ? theme.colors.primary : theme.colors.surface,
          position: 'absolute',
          top: '2px',
          left: isOn ? '26px' : '2px',
        }}
