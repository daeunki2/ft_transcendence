...
export const friendService = {
  // 내 친구 목록 조회
  getFriends: async (userId: number): Promise<FriendItem[]> => {
    try {
  ...
  // 받은 친구 요청 목록 조회
  getRequests: async (userId: number): Promise<FriendItem[]> => {
    try {
  ...
  // 친구 요청 보내기
  sendRequest: async (userId: number, nickname: string) => {
    try {
  ...
  // 친구 요청 수락
  acceptRequest: async (userId: number, friendId: number) => {
    try {
  ...
  // 친구 요청 거절
  rejectRequest: async (userId: number, friendId: number) => {
    try {
